...
const products: ProductType[] = [
    {
        id: 1,
        link: ['Home', 'Services', 'Device Management', 'Help'],
    },
    {
        id: 2,
        link: ['Help', 'About', 'Team', 'Contact Us']
    }
]

const footer = () => {
    return (
        <div className="bg-darkblue pt-1"> {/*footer background size and colour*/}
            <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        <div className="flex gap-2">
                            ...
                            <h5 className="text-base font-normal text-offwhite">Department of Computer Engineering, University of Peradeniya</h5>
                        </div>
                        ...
                        <div className="flex gap-2 mt-10">
                            ...
                            <h5 className="text-base font-normal text-offwhite">OceanEyes@gmail.com</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='text-offwhite text-sm text-center lg:text-start font-normal'>@2025 OceanEyes. All Rights Reserved by <Link href="https://oceaneyes.com/" target="_blank"> oceaneyes.com</Link></h4>
